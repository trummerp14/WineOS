...
public class Fertigungsanlage {
	...
	public List<String> getBestandteile() {
		List<String> res = Arrays.asList(bestandteile.split(";"));
		return res;
	}
	...
	public void addBestandteile(String bestandteil) {
		...
		if (this.bestandteile == null) {
			br.append(bestandteil);
		} else {
			br.append(this.bestandteile).append(";").append(bestandteil);
		}
		this.bestandteile = br.toString();
	}
